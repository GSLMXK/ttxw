...
class SysuserModel extends Model{
    ...
    protected $_validate = array(
        array('sysu_account','',array('success'=>false,'msg'=>'账号已经使用！'),1,'unique',1),
    );
    ...
    public function getAllList($map){
        ...
        $total = M('sysuser')->where($map)->count();
        $listRow = 3;
        ...
        //当前条件下的新闻数据
        $list['sysuser'] = M('sysuser')->where($map)->limit($page->firstRow,$page->listRows)->select();
