...
<body>
            ...
            <div class="sys_menu">
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <select name="field" class="search_list">
            ...
            <tbody>
                <?php if(is_array($Data)): foreach($Data as $key=>$v): ?><tr>
                        ...
                        <td>
                            ...
                            <a class="layui-btn layui-btn-warm layui-btn-small delete" name="<?php echo ($v['scid']); ?>">
    ...
    var schoolInfo = "<?php echo U('School/schoolInfo');?>";
    ...
    var delete_school = "<?php echo U('School/delete_school');?>";
