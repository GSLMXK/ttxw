...
<body>
            ...
            <tbody>
                <?php if(is_array($Data)): foreach($Data as $key=>$v): ?><tr>
                        ...
                        <td>
                            ...
                            <a class="layui-btn layui-btn-warm layui-btn-small delete" name="<?php echo ($v['type_id']); ?>">
    ...
    var modify_check = "<?php echo U('Sctype/modify_check');?>";
    var type_modify = "<?php echo U('Sctype/type_modify');?>";
    var delete_sctype = "<?php echo U('Sctype/delete_sctype');?>";
    </script>
    <script src="/zscs/Public/static/js/sctype.js"></script>
</body>
